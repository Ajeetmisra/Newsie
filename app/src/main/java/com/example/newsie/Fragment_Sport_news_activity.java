...
public class Fragment_Sport_news_activity extends Fragment {
    public Fragment_Sport_news_activity() {
    }
    ListView lv;
    TextView textView;
    private NewsDataAdapter dataAdapter;
    private SportActivityViewModel sportActivityViewModel;
    ArrayList<News> info;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        super.onViewCreated(view, savedInstanceState);
            ...
            sportActivityViewModel.getSportNews().observe(getViewLifecycleOwner(), new Observer<List<News>>() {
