...
public class Fragment_Technology_news_activity extends Fragment {
    public Fragment_Technology_news_activity() {
    }
    ListView lv;
    TextView textView;
    private NewsDataAdapter dataAdapter;
    private TechnologyActivityViewModel technologyActivityViewModel;
    ArrayList<News> info;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        super.onViewCreated(view, savedInstanceState);
            ...
            technologyActivityViewModel.gettechnologyNews().observe(getViewLifecycleOwner(), new Observer<List<News>>() {
