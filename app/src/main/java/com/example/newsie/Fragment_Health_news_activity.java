...
public class Fragment_Health_news_activity extends Fragment {
    public Fragment_Health_news_activity() {
    }
    ListView lv;
    TextView textView;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        super.onViewCreated(view, savedInstanceState);
            ...
            healthActivityViewModel.getHealthNews().observe(getViewLifecycleOwner(), new Observer<List<News>>() {
