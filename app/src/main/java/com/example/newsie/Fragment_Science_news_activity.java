...
public class Fragment_Science_news_activity extends Fragment {
    public Fragment_Science_news_activity() {
    }
    ListView lv;
    TextView textView;
    private NewsDataAdapter dataAdapter;
    private ScienceActivityViewModel scienceActivityViewModel;
    ArrayList<News> info;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        super.onViewCreated(view, savedInstanceState);
            ...
            scienceActivityViewModel.getScienceNews().observe(getViewLifecycleOwner(), new Observer<List<News>>() {
