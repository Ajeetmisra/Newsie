...
public class Fragment_business_news_activity extends Fragment {
    public Fragment_business_news_activity() {
    }
    ListView lv;
    TextView textView;
    private NewsDataAdapter dataAdapter;
    private BuisnessActivityViewModel buisnessActivityViewModel;
    ArrayList<News> info;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        super.onViewCreated(view, savedInstanceState);
            ...
            buisnessActivityViewModel.getbuisnessNEWS().observe(getViewLifecycleOwner(), new Observer<List<News>>() {
